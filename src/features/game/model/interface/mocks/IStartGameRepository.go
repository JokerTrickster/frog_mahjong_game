...
// UpdateRoomUser provides a mock function with given fields: c, updateRoomUsers
func (_m *IStartGameRepository) UpdateRoomUser(c context.Context, updateRoomUsers []mysql.RoomUsers) error {
	ret := _m.Called(c, updateRoomUsers)
