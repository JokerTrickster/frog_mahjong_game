...
func NewFCMTokenAuthHandler(c *echo.Echo, useCase _interface.IFCMTokenAuthUseCase) _interface.IFCMTokenAuthHandler {
	...
	c.POST("/v0.1/game/auth/fcm-token", handler.FCMToken, mw.TokenChecker)
	return handler
}

// fcm 토큰 저장
// @Router /v0.1/game/auth/fcm-token [post]
// @Summary Fcm 토큰 저장
// @Description
...
// @Param json body request.ReqGameFCMToken true "이메일, 비밀번호"
// @Produce json
