...
func NewSignupAuthHandler(c *echo.Echo, useCase _interface.ISignupAuthUseCase) _interface.ISignupAuthHandler {
	...
	c.POST("/v0.1/game/auth/signup", handler.Signup)
	return handler
}

// 이메일 회원 가입
// @Router /v0.1/game/auth/signup [post]
// @Summary 이메일 회원 가입
// @Description
...
// @Param json body request.ReqGameSignup true "이름, 이메일, 비밀번호"
// @Produce json
