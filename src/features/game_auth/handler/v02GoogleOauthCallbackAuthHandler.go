...
func NewV02GoogleOauthCallbackAuthHandler(c *echo.Echo, useCase _interface.IV02GoogleOauthCallbackAuthUseCase) _interface.IV02GoogleOauthCallbackAuthHandler {
	...
	c.GET("/v0.2/game/auth/google/callback", handler.V02GoogleOauthCallback)
	return handler
}

// google oauth 로그인 콜백
// @Router /v0.2/game/auth/google/callback [get]
...
// @Produce json
// @Success 200 {object} response.ResGameV02GoogleOauthCallback
// @Failure 400 {object} error
// @Failure 500 {object} error
// @Tags game/auth
func (d *V02GoogleOauthCallbackAuthHandler) V02GoogleOauthCallback(c echo.Context) error {
	ctx := context.Background()
	req := &request.ReqGameV02GoogleOauthCallback{}
