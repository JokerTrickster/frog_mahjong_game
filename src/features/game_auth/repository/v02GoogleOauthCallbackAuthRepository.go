...
func (g *V02GoogleOauthCallbackAuthRepository) FindOneAndUpdateUser(ctx context.Context, entity *entity.V02GoogleOauthCallbackSQLQuery) (*mysql.GameUsers, error) {
...
func (g *V02GoogleOauthCallbackAuthRepository) CreateUser(ctx context.Context, user *mysql.GameUsers) (*mysql.GameUsers, error) {
...
func (d *V02GoogleOauthCallbackAuthRepository) CheckToken(ctx context.Context, uID uint) (*mysql.Tokens, error) {
	token := &mysql.Tokens{}
