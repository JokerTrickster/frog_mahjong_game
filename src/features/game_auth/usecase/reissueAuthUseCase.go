...
func (d *ReissueAuthUseCase) Reissue(c context.Context, req *request.ReqGameReissue) (response.ResGameReissue, error) {
	...
	if err != nil {
		return response.ResGameReissue{}, err
	}
