...
func (g *OutRoomsRepository) FindOneUser(ctx context.Context, tx *gorm.DB, uID uint) (mysql.Users, error) {
...
func (g *OutRoomsRepository) ChangeRoomOnwer(ctx context.Context, tx *gorm.DB, RoomID uint, ownerID uint) error {
...
func (g *OutRoomsRepository) FindOneRoomUser(ctx context.Context, tx *gorm.DB, RoomID uint) (mysql.RoomUsers, error) {
...
// 방 삭제
func (g *OutRoomsRepository) FindOneAndDeleteRoom(ctx context.Context, tx *gorm.DB, RoomID uint) error {
	var room mysql.Rooms
...
func (g *OutRoomsRepository) FindOneAndDeleteRoomUser(ctx context.Context, tx *gorm.DB, uID uint, RoomsID uint) error {
	var roomUser mysql.RoomUsers
...
func (g *OutRoomsRepository) FindOneAndUpdateRoom(ctx context.Context, tx *gorm.DB, RoomID uint) (mysql.Rooms, error) {
	// 방 인원 -1
	var room mysql.Rooms
...
func (g *OutRoomsRepository) FindOneAndUpdateUser(ctx context.Context, tx *gorm.DB, uID uint) error {
	user := mysql.Users{
		State:  "wait",
		RoomID: 1,
	}
