...
// IListRoomsRepository is an autogenerated mock type for the IListRoomsRepository type
type IListRoomsRepository struct {
	mock.Mock
}

// CountRoomList provides a mock function with given fields: ctx
func (_m *IListRoomsRepository) CountRoomList(ctx context.Context) (int, error) {
	ret := _m.Called(ctx)
...
func (_m *IListRoomsRepository) FindRoomList(ctx context.Context, page int, pageSize int) ([]mysql.Rooms, error) {
...
// NewIListRoomsRepository creates a new instance of IListRoomsRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIListRoomsRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *IListRoomsRepository {
	mock := &IListRoomsRepository{}
	mock.Mock.Test(t)
