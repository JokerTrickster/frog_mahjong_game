...
func NewCheckSigninAuthHandler(c *echo.Echo, useCase _interface.ICheckSigninAuthUseCase) _interface.ICheckSigninAuthHandler {
	...
	c.POST("/v0.1/auth/signin/check", handler.CheckSignin)
	return handler
}

// 로그인 체크
// @Router /v0.1/auth/signin/check [post]
// @Summary 로그인 체크
// @Description
...
// @Param json body request.ReqCheckSignin true "이메일, 비밀번호"
// @Produce json
