...
func NewAlertUsersHandler(c *echo.Echo, useCase _interface.IAlertUsersUseCase) _interface.IAlertUsersHandler {
	...
	c.PUT("/v0.1/users/alert", handler.Alert, mw.TokenChecker)
	return handler
}

// 유저 알람 활성화/비활성화 수정하기
// @Router /v0.1/users/alert [put]
...
// @Param json body request.ReqAlertUsers true "활성화 (true) / 비활성화 (false)"
// @Produce json
