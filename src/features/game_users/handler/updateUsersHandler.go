...
func NewUpdateUsersHandler(c *echo.Echo, useCase _interface.IUpdateUsersUseCase) _interface.IUpdateUsersHandler {
	...
	c.PUT("/v0.1/game/users", handler.Update, mw.TokenChecker)
	return handler
}

// 유저 정보 수정하기
// @Router /v0.1/game/users [put]
// @Summary 유저 정보 수정하기
// @Description
...
// @Param json body request.ReqUpdateGameUsers true "json body"
// @Produce json
...
func (d *UpdateUsersHandler) Update(c echo.Context) error {
	...
	req := &request.ReqUpdateGameUsers{}
