...
func NewListProfilesUsersHandler(c *echo.Echo, useCase _interface.IListProfilesUsersUseCase) _interface.IListProfilesUsersHandler {
	...
	c.GET("/v0.1/game/users/profiles", handler.ListProfiles, mw.TokenChecker)
	return handler
}

// 유저 프로필 리스트 가져오기
// @Router /v0.1/game/users/profiles [get]
...
// @Produce json
// @Success 200 {object} response.ResListProfileGameUser
