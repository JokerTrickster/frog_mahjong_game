...
func PlayTogetherInsertUserDTO(ctx context.Context, tx *gorm.DB, userDTO *mysql.SlimeWarUsers) *entity.ErrorInfo {
...
func PlayTogetherInsertGameRoomSettingDTO(ctx context.Context, tx *gorm.DB, gameRoomSettingDTO *mysql.SlimeWarGameRoomSettings) *entity.ErrorInfo {
