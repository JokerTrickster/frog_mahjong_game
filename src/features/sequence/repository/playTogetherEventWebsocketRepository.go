...
func PlayTogetherInsertOneRoomSetting(ctx context.Context, tx *gorm.DB, roomSettingDTO *mysql.SequenceGameRoomSettings) *entity.ErrorInfo {
...
func PlayTogetherInsertUserDTO(ctx context.Context, tx *gorm.DB, userDTO *mysql.SequenceUsers) *entity.ErrorInfo {
...
func PlayTogetherInsertGameRoomSettingDTO(ctx context.Context, tx *gorm.DB, gameRoomSettingDTO *mysql.SequenceGameRoomSettings) *entity.ErrorInfo {
