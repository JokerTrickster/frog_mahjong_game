...
func GetCardFindOneCardInfo(ctx context.Context, tx *gorm.DB, roomID uint, uID uint) (*mysql.SequenceRoomCards, *entity.ErrorInfo) {
	cardInfo := &mysql.SequenceRoomCards{}
