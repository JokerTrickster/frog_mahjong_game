...
func MatchInsertOneRoomSetting(ctx context.Context, tx *gorm.DB, roomSettingDTO *mysql.SequenceGameRoomSettings) *entity.ErrorInfo {
...
func MatchInsertUserDTO(ctx context.Context, tx *gorm.DB, userDTO *mysql.SequenceUsers) *entity.ErrorInfo {
...
func MatchInsertGameRoomSettingDTO(ctx context.Context, tx *gorm.DB, gameRoomSettingDTO *mysql.SequenceGameRoomSettings) *entity.ErrorInfo {
