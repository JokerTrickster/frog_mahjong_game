...
func JoinPlayInsertUserDTO(ctx context.Context, tx *gorm.DB, userDTO *mysql.SequenceUsers) *entity.ErrorInfo {
...
func JoinPlayInsertGameRoomSettingDTO(ctx context.Context, tx *gorm.DB, gameRoomSettingDTO *mysql.SequenceGameRoomSettings) *entity.ErrorInfo {
