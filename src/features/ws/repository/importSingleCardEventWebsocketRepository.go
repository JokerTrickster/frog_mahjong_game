...
func ImportSingleCardFindOneDora(ctx context.Context, tx *gorm.DB, roomID uint) (*mysql.FrogUserCards, error) {
...
func ImportSingleCardUpdateCardState(ctx context.Context, tx *gorm.DB, entity *entity.WSImportSingleCardEntity) error {
	card := entity.Cards
	err := tx.Model(&mysql.FrogUserCards{}).
...
func ImportSingleCardUpdateRoomUserCardCount(ctx context.Context, tx *gorm.DB, entity *entity.WSImportSingleCardEntity) error {
	card := entity.Cards
...
func ImportSingleCardFindAllCard(ctx context.Context, tx *gorm.DB, roomID uint, userID uint) ([]*mysql.FrogUserCards, error) {
